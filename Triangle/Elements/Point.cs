...
namespace Triangle.Elements
{
    public class Point
    {
        ...
        {   
            double distance;
            distance = (this.coordinateX - secondPoint.coordinateX) * (this.coordinateX - secondPoint.coordinateX) + (this.coordinateY - secondPoint.coordinateY) * (this.coordinateY - secondPoint.coordinateY);
